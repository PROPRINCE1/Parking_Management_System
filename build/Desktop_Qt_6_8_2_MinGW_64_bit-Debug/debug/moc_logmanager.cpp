...
static constexpr auto qt_meta_stringdata_ZN10logmanagerE = QtMocHelpers::stringData(
    "logmanager"
);
...
Q_CONSTINIT static const uint qt_meta_data_ZN10logmanagerE[] = {
...
Q_CONSTINIT const QMetaObject logmanager::staticMetaObject = { {
    ...
    qt_meta_stringdata_ZN10logmanagerE.offsetsAndSizes,
    qt_meta_data_ZN10logmanagerE,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN10logmanagerE_t,
        // Q_OBJECT / Q_GADGET
...
void *logmanager::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ZN10logmanagerE.stringdata0))
